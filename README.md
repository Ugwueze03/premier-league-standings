...
This project demonstrates how match-level football data can be aggregated into official Premier League standings using SQL.
...
➡️ **[matches_statistics.csv](./matches_statistics.csv)**
...
> **Note:** This project currently focuses on generating accurate Premier League standings from raw match data. The next phase will extend the project with analytical SQL queries and football performance insights.
